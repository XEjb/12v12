...
function SelectVO(keys)
	...
	if keys.num >= startheronums then
		...
		selectedstr = HERO_LIST_VO[math.floor(locnum/8)+1]..mesarrs[math.fmod(locnum,8)+1]
		...
		if keys.num < (startheronums-8) then
			...
			local herolocid = 2
			for i=1, #HERO_LIST_VO do
				if nowheroname == HERO_LIST_VO[i] then
					break
				end
