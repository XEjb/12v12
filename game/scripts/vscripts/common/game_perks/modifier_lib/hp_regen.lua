...
function hp_regen_t0:OnCreated() self.v = {2.5, 1, 0.25} end
function hp_regen_t1:OnCreated() self.v = {5, 1, 0.5} end
function hp_regen_t2:OnCreated() self.v = {10, 1, 1} end
function hp_regen_t3:OnCreated() self.v = {20, 1, 2} end
